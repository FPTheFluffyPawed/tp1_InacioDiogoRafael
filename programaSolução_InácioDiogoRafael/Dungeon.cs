...
namespace programaSolução_InácioDiogoRafael
{
    ...
    class Dungeon
    {
        ...
        /// </summary>
        /// <returns>Fantasma atualmente na masmorra.</returns>
        public List<Ghost> GetPrisionerList() => prisioners;

        /// <summary>
        /// Metódo para atualizar e adicionar um fantasma a lista de prisioneiros.
        /// </summary>
        /// <param name="newGuy">Fantasma a ser mandado para a masmorra.</param>
        public void UpdatePrisionerList(Ghost newGuy)
        {
            ...
            // Retira o fantasma a ser adicionado da lista de fantasmas do jogador...
        ...
        /// <summary>
        /// Metódo para atualizar e libertar um fantasma da lista de prisioneiros.
        /// </summary>
        /// <param name="freeGuy">Fantasma a ser libertado da masmorra.</param>
        public void ReleasePrisioner(Ghost freeGuy)
        {
            // Asinala o fantasma a ser libertado que já não está na masmorra...
            freeGuy.inDungeon = false;
            // Adiciona o fantasma a ser libertado a lista de fantasmas do jogador...
            freeGuy.owner.playerGhosts.Add(freeGuy);
            // Retira o fantasma a ser libertado da lista de fantasmas na masmorra...
