...
namespace programaSolução_InácioDiogoRafael
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(board.GetTileType(0, 0));
            Console.WriteLine(board.GetTileType(0, 1));
            Console.WriteLine(board.GetTileType(0, 2));
            Console.WriteLine(board.GetTileType(0, 3));
            Console.WriteLine(board.GetTileType(0, 4));
